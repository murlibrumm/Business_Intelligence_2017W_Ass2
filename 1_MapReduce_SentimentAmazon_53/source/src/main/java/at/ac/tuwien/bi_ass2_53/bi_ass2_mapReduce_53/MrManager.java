...
public class MrManager extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		float good = counters.findCounter("at.ac.tuwien.bi_ass2_53.bi_ass2_mapReduce_53.Map$Gauge", "POSITIVE").getValue();
		float bad = counters.findCounter("at.ac.tuwien.bi_ass2_53.bi_ass2_mapReduce_53.Map$Gauge", "NEGATIVE").getValue();
